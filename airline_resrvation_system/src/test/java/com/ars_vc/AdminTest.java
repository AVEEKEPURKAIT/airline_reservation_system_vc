...
//	Admin admin=Admin.builder().aName("Aveeke").email("aveeke@gmail.com").UserName("ave123").password("avi@123").role("admin").build();
...
//	assertThat(adto.getAName()).isEqualTo("Aveeke");
//	}
